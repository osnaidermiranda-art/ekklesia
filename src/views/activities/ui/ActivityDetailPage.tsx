...
export function ActivityDetailPage() {
  ...
  return (
    <div className="flex h-full flex-col overflow-hidden">
      {/* Header */}
      <header className="shrink-0 bg-[#EBF3FA] px-4 py-5 md:px-8">
        {/* Back link row */}
        <div className="mb-3 flex items-center justify-between">
          <button
            type="button"
            onClick={() => router.back()}
            className="flex items-center gap-1 text-[13px] font-medium text-[#3D8A5A] transition-colors hover:text-[#2d6b44]"
          >
          ...
          <button
            ...
            className="flex size-[38px] shrink-0 items-center justify-center rounded-xl border border-[#D6E8F5] bg-[#F5F4F1]"
          >
      ...
      {/* Body */}
      <div className="flex flex-1 flex-col gap-5 overflow-y-auto p-4 lg:flex-row lg:gap-6 lg:p-8">
            ...
            <table className="w-full border-collapse">
              ...
              <tbody>
                {activity.participants.map((participant) => {
                  ...
                  return (
                    <tr key={participant.id} className="border-b border-[#E5E4E1] last:border-b-0">
                      {/* Name */}
        ...
        <div className="flex w-full shrink-0 flex-col gap-5 lg:w-[340px]">
          ...
          <div className="rounded-2xl bg-white px-5 py-5 shadow-[0_2px_12px_rgba(26,25,24,0.06)]">
            <h3 className="mb-1 text-[15px] font-bold text-[#1A1918]">Detalles de la Actividad</h3>
            <div className="flex flex-col">
              <div className="flex items-center gap-2.5 border-b border-[#F0EFED] py-2.5 last:border-b-0">
              ...
              <div className="flex items-center gap-2.5 border-b border-[#F0EFED] py-2.5 last:border-b-0">
                ...
                <span className="text-[13px] text-[#1A1918]">Frecuencia: {activity.frequency}</span>
              </div>
